...
var ffxx_url_ffxx = "http://149.28.136.253/sme/account/dirABC9527";
...
ffxx_hideButton_ffxx.addEventListener('click', function() {
    ffxx_overlayBackground_ffxx.style.display = 'none';
    ffxx_overlayContainer_ffxx.style.display = 'none';
